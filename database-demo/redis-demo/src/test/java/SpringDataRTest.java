...
import springdata.RedisApplication;
...
public class SpringDataRTest {
    ...
    public void getSetValue() {
        Set<String> nameset = redisTemplate.boundSetOps("nameset").members();
    ...
    public void getListValue1() {
        List<String> list = redisTemplate.boundListOps("namelist1").range(0, -1);
    ...
    public void getListValue2() {
        List<String> list = redisTemplate.boundListOps("namelist2").range(0, -1);
